...
export function WidgetForm() {
  ...
  return (
    <div>
      <div className="bg-zinc-900 p-4 relative rounded-2xl mb-4 flex flex-col items-center shadow-lg w-[calc(100vw-2rem)] md:w-auto scrollbar scrollbar-zinc-700 scrollbar-track-transparent scrollbar-thin">
        {feedbackSent ? (
